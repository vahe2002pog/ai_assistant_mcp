...
Шаг 2: Вставь из буфера в поле
  ui_click(handle=text_field)  # убедись что поле в фокусе
...
Используй ui_send_keys() ТОЛЬКО если нужны специальные клавиши:
  ui_send_keys(handle=field, text="{Ctrl}a{Delete}")  # выделить и удалить
  ui_send_keys(handle=field, text="password{Enter}")  # текст + Enter
