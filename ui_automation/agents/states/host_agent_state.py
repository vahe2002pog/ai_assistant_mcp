...
from ui_automation.agents.states.basic import AgentState, AgentStateManager
...
if TYPE_CHECKING:
    from ui_automation.agents.agent.app_agent import AppAgent, OpenAIOperatorAgent
    from ui_automation.agents.agent.host_agent import HostAgent
    from ui_automation.agents.states.app_agent_state import AppAgentState
...
class AssignHostAgentState(HostAgentState):
    ...
    def next_state(self, agent: "HostAgent") -> AppAgentState:
        ...
        from ui_automation.agents.agent.app_agent import OpenAIOperatorAgent

        if type(next_agent) == OpenAIOperatorAgent:

            from ui_automation.agents.states.operator_state import ContinueOpenAIOperatorState

            return ContinueOpenAIOperatorState()
        else:
            from ui_automation.agents.states.app_agent_state import ContinueAppAgentState
